// $Smake: nvcc -O2 -o %F %f
//
// copy-vectors.cu - copy one array to another on GPU device
//
...
int main(int argc, char* argv[])
{
    ...
    copy_vector<<<num_blocks, block_size>>>(d_c, d_a, n);

// $Smake: nvcc -O2 -o %F %f
//
// mul-vectors.cu - multiply of two arrays on GPU device
//
...
__global__ void mul_vectors(
    float *c,      // out - pointer to result float c
...
int main(int argc, char* argv[])
{
    ...
    mul_vectors<<<num_blocks, block_size>>>(d_c, d_a, d_b, n);
